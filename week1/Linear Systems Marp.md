...
3. Operation 3: $-\frac{1}{5}R_2=R_2$
...
- We learned how to represent a linear system as an augmented matrix.
- We learned the row operations
- We learned the difference between row echelon and reduced row echelon form
- We learned how to determine the system solution from the reduced matrix.